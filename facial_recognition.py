...
class Face_Recognition:
    ...
    def face_recog(self):
        ...
        # df_state=pd.read_csv(r"E:\6th sem\my_project\Face_reg\face_recognize_student_attendence_system\Shivansh.csv")
...
#         img_bottom=img_bottom.resize((712, 650),Image.LANCZOS)
#         self.photoimg_bottom=ImageTk.PhotoImage(img_bottom)
