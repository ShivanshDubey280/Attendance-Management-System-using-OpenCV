...
class Student:
    ...
    #     img=img.resize((450,120),Image.LANCZOS)  #LANCZOS lea high level image lai low level mah convert garxa
    ...
    #     img1=img1.resize((450,120),Image.LANCZOS)  #LANCZOS lea high level image lai low level mah convert garxa
    ...
    #Third Image
        ...
        img2 = img2.resize((1366,120),Image.LANCZOS)  #LANCZOS lea high level image lai low level mah convert garxa
    ...
    #Background image 
        ...
        img3 = img3.resize((1530,730),Image.LANCZOS)  #LANCZOS lea high level image lai low level mah convert garxa
        ...
        img_left = img_left.resize((660,90),Image.LANCZOS)  #LANCZOS lea high level image lai low level mah convert garxa
 ...
 #Right label frame
        ...
        img_right = img_right.resize((650,75),Image.LANCZOS)  #LANCZOS lea high level image lai low level mah convert garxa
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                conn=mysql.connector.connect(host="localhost",username="root",password="Aezakmi@321",database="face_recognition")
