...
class Developer:
    def __init__(self,root):
        ...
        # Developer Info
        dev_lb=Label(main_frame,text="Shivansh Dubey",font=("time new roman",15,"bold"),bg="white",fg="#142552")
        dev_lb.place(x=10,y=45)

        dev_lb=Label(main_frame,text="Harsha Bhatt",font=("time new roman",15,"bold"),bg="white",fg="#142552")
